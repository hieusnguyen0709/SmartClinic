                ...
                <div class="card mb-4">
                    <div class="table-header">
                        <div class="card-header d-flex w-100 mb-0">
                            <div class="w-50">
                                <h5>Roles</h5>
                                @if (in_array(config('constants.PERMISSION.CREATE_ROLE') , $permissions))
                                <button class="text-uppercase btn bg-gradient-success" onclick="location.href='{{ route('role.create') }}'">Create&nbsp;&nbsp;<i class="fas fa-plus"></i></button>
                                @endif
                                @if (in_array(config('constants.PERMISSION.DELETE_ROLE') , $permissions))
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            @if (in_array(config('constants.PERMISSION.EDIT_ROLE') , $permissions))
