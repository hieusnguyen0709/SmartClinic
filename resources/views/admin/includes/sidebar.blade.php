...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        @if (in_array(config('constants.PERMISSION.VIEW_USER') , $permissions))
        <li class="nav-item">
        ...
        @endif
        @if (in_array(config('constants.PERMISSION.VIEW_ROLE') , $permissions))
        <li class="nav-item">
        ...
        @endif
        @if (in_array(config('constants.PERMISSION.VIEW_CATEGORY') , $permissions))
        <li class="nav-item">
        ...
        @endif
        @if (in_array(config('constants.PERMISSION.VIEW_MEDICINE') , $permissions))
        <li class="nav-item">
        ...
        @endif
        @if (in_array(config('constants.PERMISSION.VIEW_PRESCRIPTION') , $permissions))
        <li class="nav-item">
        ...
        @endif
        @if (in_array(config('constants.PERMISSION.VIEW_FRAME') , $permissions))
        <li class="nav-item">
        ...
        @endif
        @if (in_array(config('constants.PERMISSION.VIEW_SCHEDULE') , $permissions))
        <li class="nav-item">
        ...
        @endif
        @if (in_array(config('constants.PERMISSION.VIEW_APPOINTMENT') , $permissions))
        <li class="nav-item">
